...
public interface MediaService {
    MediaResponse uploadMedia(MultipartFile file, String altText, Long linkedPostId, Long requesterId, boolean isAdmin);
    ...
    MediaResponse linkToPost(Long mediaId, Long postId, Long requesterId, boolean isAdmin);
